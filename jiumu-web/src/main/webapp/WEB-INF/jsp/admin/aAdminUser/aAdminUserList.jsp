...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        <section class="content-header">
            <h1>
                列表
                <a class="btn btn-app" href="admin/aAdminUser/detail"><i class="fa fa-edit"></i>新增</a>
            </h1>
            <ol class="breadcrumb">
...
<script language="javascript" type="text/javascript" src="${ctxPath}assets/admin/js/My97DatePicker/WdatePicker.js"></script><script src="assets/admin/app/aAdminUser/aAdminUserPaging.js" type="text/javascript"></script>
</body>
</html>
