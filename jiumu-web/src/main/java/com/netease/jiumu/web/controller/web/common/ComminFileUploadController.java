package com.netease.jiumu.web.controller.web.common;
...
public class ComminFileUploadController extends BaseController {
    ...
    public String fileUpload(@RequestParam MultipartFile[] myfiles,@PathVariable String folder,
